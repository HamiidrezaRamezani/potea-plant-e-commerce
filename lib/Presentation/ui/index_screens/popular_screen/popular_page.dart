...
class _MostPopularPageState extends State<MostPopularPage> {
  ...
  List<ProductModelUi> mostPopularProductList = [
    ProductModelUi(
      ...
      body: ListView(
        children: [
          ListTile(
            ...
            title: TextStyles.heading4('Most Popular', AppColors.grey900),
                  ...
                  return AppPadding.paddingOnlyWidget(
                      SizedBox(
                        ...
                        child: AppProduct.popularProduct(
                            mostPopularProductList[index].image,
                            mostPopularProductList[index].title,
                            mostPopularProductList[index].rate,
                            mostPopularProductList[index].status,
                            mostPopularProductList[index].price,
                            mostPopularProductList[index].isPopular,
                                (){}),
                      ),
                      0.0,
                      0.0,
