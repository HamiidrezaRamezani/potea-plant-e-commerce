...
import 'package:potea_plant_e_commerce/Presentation/ui/authentication_screens/login/easy_login_page.dart';
            ...
            child: AppPadding.paddingOnlyWidget(
                InkWell(
                  onTap: () {
                    ...
                    if(_currentPage >= 2){
                      Navigator.push(context, MaterialPageRoute(builder: (context)=> EasyLoginPage()));
                    }
                  },
